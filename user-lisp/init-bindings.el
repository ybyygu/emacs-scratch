...
(gwp::leader-def
  ...
  "l 1" '((lambda () (interactive) (tab-select 1)) :which-key "switch to tab 1")
  "l 2" '((lambda () (interactive) (tab-select 2)) :which-key "switch to tab 2")
  "l 3" '((lambda () (interactive) (tab-select 3)) :which-key "switch to tab 3")
  "l 4" '((lambda () (interactive) (tab-select 4)) :which-key "switch to tab 4")
  "l 5" '((lambda () (interactive) (tab-select 5)) :which-key "switch to tab 5")
  "l 6" '((lambda () (interactive) (tab-select 6)) :which-key "switch to tab 6")
  "l 7" '((lambda () (interactive) (tab-select 7)) :which-key "switch to tab 7")
  "l 8" '((lambda () (interactive) (tab-select 8)) :which-key "switch to tab 8")
  "l 9" '((lambda () (interactive) (tab-select 9)) :which-key "switch to tab 9")
  "l <backspace>" '(tab-previous :which-key "prev tab")
  "l <right>" '(tab-move :which-key "move tab to right")
  "l <left>" '((lambda() (interactive) (tab-move -1)) :which-key "move tab to left")
